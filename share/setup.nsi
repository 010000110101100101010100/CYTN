...
!define URL http://www.cryptoken.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/cryptoken.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\cryptoken-qt.exe
...
OutFile cryptoken-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/cryptoken-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/cryptokend.exe
    ...
    #Delete /REBOOTOK $INSTDIR\cryptoken.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\cryptoken-qt.exe
