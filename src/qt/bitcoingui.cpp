...
//    connect(yobitAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Cryptoken"), this);
    aboutAction->setToolTip(tr("Show information about Cryptoken"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo-64"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Cryptoken"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenu *walletsec = appMenuBar->addMenu(tr("&Wallet Sec"));
    walletsec->addAction(encryptWalletAction);
    walletsec->addSeparator();
    walletsec->addAction(changePassphraseAction);
    walletsec->addSeparator();
    walletsec->addAction(unlockWalletAction);
    walletsec->addSeparator();
    walletsec->addAction(lockWalletAction);
    walletsec->addSeparator();
    walletsec->addAction(backupWalletAction);
    walletsec->addSeparator();
    walletsec->addAction(exportAction);
    walletsec->addSeparator();
    walletsec->addAction(signMessageAction);
    walletsec->addSeparator();
...
//    trade->addAction(yobitAction);
    ...
    QMenu *Printing = appMenuBar->addMenu(tr("&Printing"));

    QMenu *Examples = appMenuBar->addMenu(tr("&Examples"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Cryptoken client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Cryptoken client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cryptoken network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Cryptoken address or malformed URI parameters."));
    }
