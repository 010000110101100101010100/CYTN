...
private slots:
    ...
    void on_BuyCYT_clicked();
    void on_SellCYTBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputCYT_textChanged(const QString &arg1);
    ...
    QString BuyCYT(QString OrderType, double Quantity, double Rate);
    QString SellCYT(QString OrderType, double Quantity, double Rate);
